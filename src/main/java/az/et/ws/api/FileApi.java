...
public class FileApi {
    ...
    public ResponseEntity<Resource> loadFile(
        ...
        return ResponseEntity.ok()
                .contentType(MediaType.parseMediaType(Objects.isNull(contentType) ? "application/octet-stream" : contentType))
                .header(HttpHeaders.CONTENT_DISPOSITION, String.format("%s%s%s", "attachment; filename=\"", file.getFilename(), "\""))
                .body(file);
    }
